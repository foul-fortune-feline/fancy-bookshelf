package com.foulfortunefeline.betterenchanting.inventory;
...
public interface ImplementedInventory extends Inventory {
     ...
     * @param amount How many items to remove. If there are less items in the slot than what are requested, takes all
     *               items in the slot
     */
    @Override
    ...
    /**
     * Replaces the current stack in an inventory with the provided stack
     ...
     * Must be called after changes in the inventory, so that the game can properly save the inventory contents and
     * notify neighboring blocks of inventory changes.
     */
    @Override
