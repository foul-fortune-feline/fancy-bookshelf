...
public class UnbakedBookCaseModel implements UnbakedModel {
    ...
    public UnbakedBookCaseModel(ModelProviderContext ctx) {
        books = new ArrayList<>();
        for (Identifier model : BetterEnchantingModelProvider.BOOKS) {
    ...
    public Collection<Identifier> getModelDependencies() {
        ArrayList<Identifier> result = new ArrayList<>(List.of(BetterEnchantingModelProvider.CASE));
        result.addAll(List.of(BetterEnchantingModelProvider.BOOKS));
        return result;
    }
    ...
    public BakedModel bake(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter
        ...
        BakedModel case_model = loader.bake(BetterEnchantingModelProvider.CASE, rotationContainer);
